...
- 2026-06-20: Safari版で他アプリ音声再生後や再生したままホームへ戻った後に音が出なくなる問題へ追加対応した。非表示化 / pagehide / 復帰時は再生状態を明示停止してUIと実音声のズレを防ぎ、Web Audio復旧フラグが立った次回再生・試聴・ウォームアップではTone.jsのAudioContextと音源チェーンを作り直す
