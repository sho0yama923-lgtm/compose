...
- 2026-06-21: ボタン連打や処理中の別ボタン操作で予想外の処理が重なる問題へ対策した。`src/core/action-guard.js` に共通の排他アクションガードを追加し、通常ボタンには短い連打吸収、作成/読込/削除/インポート/エクスポート/再生開始/音源試聴/トラック追加削除/小節追加削除には処理完了までの排他ロックを入れた。再生ボタンは開始待ち中の停止操作だけ通せるようにした
